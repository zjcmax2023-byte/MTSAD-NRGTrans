...
class SynSegLoader(Dataset):
    def __init__(self, root_path, win_size, step=1, flag="train"):
        ...
        train_data = pd.read_csv(os.path.join(root_path, 'train_4.csv'))
        test_data = pd.read_csv(os.path.join(root_path, 'test_4.csv'))
        labels = test_data.values[:, -1:]
        train_data = train_data.values[:, :-1]
        test_data = test_data.values[:, :-1]
...
def get_loader_segment(data_path, batch_size, win_size=100, step=100, mode='train', dataset='KDD'):
    if (dataset == 'SMD'):
        ...
        # dataset = SMDSegLoader(data_path, win_size, 25, mode)
    elif (dataset == 'MSL'):
        ...
        dataset = SynSegLoader(data_path, win_size, 1, mode)
